...
const GameManageScreen = () => {
  ...
  let gather = [
    { image: 'https://mc-nugu.s3.ap-northeast-2.amazonaws.com/NUGU.png' },
  ];
    ...
    <SafeInputView>
      ...
      >
          ...
          {gameStart ? (
            <View style={styles.imageWrapper}>
              ...
              {gameName.startsWith('디') && (
                ...
                >
                  Disney image generated with Deep Learning
                </Text>
              )}
              {gameName.startsWith('랜') && (
                ...
                >
                  Image generated by GPT 4.0 & Google API
                </Text>
              )}
              {gameName.startsWith('모') && (
                <Text
        ...
        <View style={styles.bottom}>
          ...
          {gameStart && gameName.startsWith('디') && (
            <Pressable
              onPress={() => {
                sendAnswerRequest();
              }}
